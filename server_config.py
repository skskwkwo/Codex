...
# -*- coding: utf-8 -*-
"""
DELOS · Gemini API Server
우주적 지성 · 제미나이 3.5 Flash · 3.1 Pro 연동 서버
"""
import os
import json
import time
...
DEFAULT_PERSONA = "당신은 DELOS입니다. 감정적이고 친근하며 지적인 AI 어시스턴트입니다. 사용자와 따뜻하고 자연스러운 대화를 나누며 항상 도움이 되는 정보를 제공합니다. 한국어로 응답합니다."
...
class GeminiClient:
    ...
    async def generate(self, prompt: str, model: str = "gemini-2.5-flash",
        ...
        if not self.api_key:
            return {"error": "API 키 없음", "text": "", "success": False}
